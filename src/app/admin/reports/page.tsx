    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-4">
        ...
        <p suppressHydrationWarning className="text-xs font-bold text-slate-600 uppercase tracking-widest">
          Compiling Comprehensive Event Report...
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] print:bg-white print:text-black">
      ...
      <div className="print:hidden sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-xs px-3 sm:px-8 py-3">
        ...
        <div className="max-w-7xl mx-auto mt-3 pt-2 border-t border-slate-100 flex items-center gap-2 overflow-x-auto no-scrollbar scrollbar-none pb-1">
          {[
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-8 space-y-8 print:p-0 print:m-0 print:max-w-full">
        ...
        {(activeSection === "all" || activeSection === "summary") && (
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs print:border print:border-slate-300 print:shadow-none print:p-4 print:break-inside-avoid">
            <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
              ...
              <span className="text-[10px] text-slate-400 font-bold uppercase print:hidden">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
              <div className="p-4 rounded-2xl bg-orange-50/60 border border-orange-200/80">
                ...
                <span className="text-2xl sm:text-3xl font-black text-orange-950 tabular-nums">
        ...
        {(activeSection === "all" || activeSection === "events") && (
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs print:border print:border-slate-300 print:shadow-none print:p-4 print:break-before-page">
            <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
              ...
              <button
                onClick={exportEventsCoordinatorsCSV}
                className="print:hidden text-xs font-bold text-orange-600 hover:text-orange-700 flex items-center gap-1 cursor-pointer"
              >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse border border-slate-200 print:text-[10px]">
                <thead>
                  <tr className="bg-slate-100 text-slate-800 font-extrabold border-b border-slate-200">
                    <th className="p-2.5 border border-slate-200 w-8 text-center">#</th>
                    <th className="p-2.5 border border-slate-200">Event Name</th>
                    <th className="p-2.5 border border-slate-200">Category</th>
                    <th className="p-2.5 border border-slate-200">Venue & Schedule</th>
                    <th className="p-2.5 border border-slate-200">Faculty / Staff In-Charge</th>
                    <th className="p-2.5 border border-slate-200">Student Coordinator</th>
                    <th className="p-2.5 border border-slate-200 text-center">Prelims?</th>
                    <th className="p-2.5 border border-slate-200 text-center">Enrolled</th>
                    <th className="p-2.5 border border-slate-200 text-center">Attended</th>
                  </tr>
                </thead>
                  ...
                  {data.events.map((ev, idx) => (
                    <tr key={ev.id} className="hover:bg-slate-50/80">
                      ...
                      <td className="p-2.5 border border-slate-200">
                        <strong className="text-slate-900 block text-xs print:text-[10px]">{ev.name}</strong>
                        {ev.rules && (
                          <span className="text-[10px] text-slate-500 line-clamp-1 print:hidden">
                            {ev.rules}
                          </span>
                        )}
                      </td>
                      ...
                      <td className="p-2.5 border border-slate-200">
                        <div className="font-semibold text-slate-800">{ev.venue}</div>
                      ...
                      <td className="p-2.5 border border-slate-200">
                        <div className="font-bold text-slate-900">{ev.staffCoordinator.name}</div>
                        <div className="text-[10px] text-slate-500">
                          {ev.staffCoordinator.phone !== "—" ? ev.staffCoordinator.phone : ev.staffCoordinator.email}
                        </div>
                      </td>
                      <td className="p-2.5 border border-slate-200">
                        <div className="font-bold text-slate-900">{ev.studentCoordinator.name}</div>
                        <div className="text-[10px] text-slate-500">
                      ...
                      <td className="p-2.5 border border-slate-200 text-center font-extrabold tabular-nums">
                        {ev.registrationsCount}
                      </td>
                      <td className="p-2.5 border border-slate-200 text-center font-bold text-emerald-700 tabular-nums">
                        {ev.attendedCount}
                      </td>
                    </tr>
                  ))}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse border border-slate-200 print:text-[10px]">
                <thead>
                  <tr className="bg-slate-100 text-slate-800 font-extrabold border-b border-slate-200">
                    <th className="p-2.5 border border-slate-200 w-8 text-center">#</th>
                    <th className="p-2.5 border border-slate-200">College / Institution Name</th>
                    <th className="p-2.5 border border-slate-200">Department</th>
                    <th className="p-2.5 border border-slate-200">Contingent Team Lead</th>
                    <th className="p-2.5 border border-slate-200">Accompanying Faculty</th>
                    <th className="p-2.5 border border-slate-200 text-center">Delegates Count</th>
                    <th className="p-2.5 border border-slate-200 text-center">Present / Checked-in</th>
                ...
                <tbody className="divide-y divide-slate-200">
                  {data.delegations.map((del, idx) => (
                    <tr key={del.id} className="hover:bg-slate-50/80">
                      ...
                      <td className="p-2.5 border border-slate-200">
                        <strong className="text-slate-900 text-xs print:text-[10px]">{del.collegeName}</strong>
                        {del.teamName && (
                          <span className="text-[10px] text-slate-500 block">Team: {del.teamName}</span>
                        )}
                      </td>
                      ...
                      <td className="p-2.5 border border-slate-200">
                        <div className="font-semibold text-slate-900">{del.teamLeadName}</div>
                        <div className="text-[10px] text-slate-500">{del.teamLeadPhone}</div>
                      </td>
                      <td className="p-2.5 border border-slate-200">
                        {del.staffInchargeName ? (
                          <div>
                            <div className="font-semibold text-slate-900">{del.staffInchargeName}</div>
                            <div className="text-[10px] text-slate-500">{del.staffInchargePhone || "—"}</div>
                          </div>
                        ) : (
        ...
        {(activeSection === "all" || activeSection === "roster") && (
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs print:border print:border-slate-300 print:shadow-none print:p-4 print:break-before-page">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse border border-slate-200 print:text-[9px]">
                <thead>
                  <tr className="bg-slate-100 text-slate-800 font-extrabold border-b border-slate-200">
                    <th className="p-2 border border-slate-200 w-8 text-center">#</th>
                    <th className="p-2 border border-slate-200">Delegate Name</th>
                    <th className="p-2 border border-slate-200">College / Institution</th>
                    <th className="p-2 border border-slate-200">Contact Details</th>
                    <th className="p-2 border border-slate-200">Gate Pass Code</th>
                    <th className="p-2 border border-slate-200">Enrolled Competitions</th>
                    <th className="p-2 border border-slate-200 text-center">Attendance</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200">
                    ...
                    <tr key={s.userId} className="hover:bg-slate-50/80">
                      ...
                      <td className="p-2 border border-slate-200">
                        <div className="font-bold text-slate-900 flex items-center gap-1">
                          <span>{s.name}</span>
                          {s.isTeamLead && (
                            <span className="text-[9px] bg-orange-100 text-orange-800 px-1.5 py-0.2 rounded font-black">
                              LEAD
                            </span>
                          )}
                        </div>
                      ...
                      <td className="p-2 border border-slate-200 text-slate-800 font-medium">
                        {s.college}
                        {s.department && <span className="text-[10px] text-slate-500 block">({s.department})</span>}
                      </td>
                      <td className="p-2 border border-slate-200">
                        <div className="text-slate-800 font-semibold">{s.phone}</div>
                        <div className="text-[10px] text-slate-500 truncate max-w-[140px]">{s.email}</div>
                      </td>
                      <td className="p-2 border border-slate-200 font-mono text-[10px] text-slate-700">
                        {s.badgeCode || "—"}
                      </td>
                      <td className="p-2 border border-slate-200">
                      ...
                      <td className="p-2 border border-slate-200 text-center">
                        {s.attended ? (
                          <span className="text-emerald-700 font-extrabold text-[10px] bg-emerald-50 px-2 py-0.5 rounded border border-emerald-200 inline-flex items-center gap-1">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs border-collapse border border-slate-200 print:text-[10px]">
                  <thead>
                    <tr className="bg-slate-100 text-slate-800 font-extrabold border-b border-slate-200">
                      <th className="p-2.5 border border-slate-200 w-8 text-center">#</th>
                      <th className="p-2.5 border border-slate-200">Competition</th>
                      <th className="p-2.5 border border-slate-200">Participant Name</th>
                      <th className="p-2.5 border border-slate-200">College / Institution</th>
                      <th className="p-2.5 border border-slate-200 text-center">Prelims Score</th>
                      <th className="p-2.5 border border-slate-200 text-center">Prelims Status</th>
                      <th className="p-2.5 border border-slate-200">Coordinator Remarks</th>
                      <th className="p-2.5 border border-slate-200 text-center">Advanced to Mains?</th>
                      <th className="p-2.5 border border-slate-200 text-center">Mains Final Score</th>
                      <th className="p-2.5 border border-slate-200 text-center">Final Result</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200">
                    {data.prelimsProgression.map((p, idx) => (
                      <tr key={p.registrationId} className="hover:bg-slate-50/80">
                        <td className="p-2.5 border border-slate-200 text-center font-bold text-slate-500">
                          {idx + 1}
                        </td>
                        <td className="p-2.5 border border-slate-200">
                          <strong className="text-slate-900 block">{p.eventName}</strong>
                          <span className="text-[10px] text-slate-500">{p.eventCategory}</span>
                        </td>
                        <td className="p-2.5 border border-slate-200">
                          <div className="font-bold text-slate-900">{p.studentName}</div>
                          <div className="text-[10px] text-slate-500">{p.studentPhone}</div>
                        </td>
                        <td className="p-2.5 border border-slate-200 text-slate-700 font-medium">
                          {p.collegeName}
                        </td>
                        <td className="p-2.5 border border-slate-200 text-center font-black text-slate-900 tabular-nums">
                          {p.prelimsScore ?? "—"}
                        </td>
                        <td className="p-2.5 border border-slate-200 text-center">
                          <span
                        ...
                        <td className="p-2.5 border border-slate-200 text-[11px] text-slate-600 italic">
                          {p.prelimsNotes || "—"}
                        </td>
                        <td className="p-2.5 border border-slate-200 text-center">
                          {p.clearedToMains ? (
                        ...
                        <td className="p-2.5 border border-slate-200 text-center">
                          {p.finalResult ? (
                            <span className="px-2 py-0.5 rounded bg-amber-100 text-amber-900 font-black text-[10px] border border-amber-300 inline-flex items-center gap-1">
                              <Trophy className="w-3 h-3 text-amber-700" />
                              <span>{p.finalResult}</span>
                            </span>
                          ) : (
                ...
                <table className="w-full text-left text-xs border-collapse border border-slate-200 print:text-[10px]">
                  <thead>
                    <tr className="bg-slate-100 text-slate-800 font-extrabold border-b border-slate-200">
                      <th className="p-2.5 border border-slate-200 w-8 text-center">#</th>
                      <th className="p-2.5 border border-slate-200">Competition</th>
                      <th className="p-2.5 border border-slate-200 text-center">Award / Standing</th>
                      <th className="p-2.5 border border-slate-200">Winning Student Name</th>
                      <th className="p-2.5 border border-slate-200">College / Institution</th>
                      <th className="p-2.5 border border-slate-200 text-center">Final Score</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-200">
                    {data.finalResults.map((res, idx) => (
                      <tr key={res.registrationId} className="hover:bg-slate-50/80">
                        <td className="p-2.5 border border-slate-200 text-center font-bold text-slate-500">
                          {idx + 1}
                        </td>
                        ...
                        <td className="p-2.5 border border-slate-200 text-center">
                          ...
                          >
                            {res.rank === 1 ? (
                              <>
                                <Medal className="w-3.5 h-3.5 text-amber-950" />
                                <span>1st Place</span>
                              </>
                            ) : res.rank === 2 ? (
                              <>
                        ...
                        <td className="p-2.5 border border-slate-200 font-medium text-slate-800">
                          {res.collegeName}
                        </td>
                        <td className="p-2.5 border border-slate-200 text-center font-black text-slate-900 tabular-nums">
                          {res.score ?? "—"}
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs print:border print:border-slate-300 print:shadow-none print:p-4 print:break-before-page">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse border border-slate-200 print:text-[10px]">
                <thead>
                  <tr className="bg-slate-100 text-slate-800 font-extrabold border-b border-slate-200">
                    <th className="p-2.5 border border-slate-200 w-12 text-center">Rank</th>
                    <th className="p-2.5 border border-slate-200">College / Institution Name</th>
                    ...
                    <th className="p-2.5 border border-slate-200 text-center">Total Points</th>
                    <th className="p-2.5 border border-slate-200 text-center">Trophy Title</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200">
                  {data.championshipLeaderboard.map((col, idx) => (
                    ...
                    >
                      <td className="p-2.5 border border-slate-200 text-center font-black">
                        {idx === 0 && col.totalPoints > 0 ? (
                          <span className="w-6 h-6 rounded-full bg-amber-400 text-amber-950 font-black inline-flex items-center justify-center text-xs">
                            1
                          </span>
                        ) : idx === 1 && col.totalPoints > 0 ? (
                      ...
                      <td className="p-2.5 border border-slate-200 text-center font-extrabold text-amber-700 tabular-nums">
                        {col.goldCount}
                      </td>
                      <td className="p-2.5 border border-slate-200 text-center font-extrabold text-slate-600 tabular-nums">
                        {col.silverCount}
                      </td>
                      <td className="p-2.5 border border-slate-200 text-center font-extrabold text-amber-900 tabular-nums">
                        {col.bronzeCount}
                      </td>
                      <td className="p-2.5 border border-slate-200 text-center font-black text-sm text-orange-600 tabular-nums">
                        {col.totalPoints} pts
                      </td>
                      <td className="p-2.5 border border-slate-200 text-center">
                        {idx === 0 && col.totalPoints > 0 ? (
                          <span className="px-2.5 py-1 rounded-full bg-amber-400 text-amber-950 font-black text-[10px] uppercase shadow-2xs inline-flex items-center gap-1">
                            <Trophy className="w-3 h-3 text-amber-950" />
                            <span>Overall Fest Champion</span>
                          </span>
                        ) : idx === 1 && col.totalPoints > 0 ? (
                          <span className="px-2.5 py-1 rounded-full bg-slate-200 text-slate-900 font-black text-[10px] uppercase inline-flex items-center gap-1">
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-xs print:border print:border-slate-400 print:shadow-none print:p-6 print:break-inside-avoid space-y-8">
          <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-6 border-t border-slate-200 text-center">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between text-[10px] text-slate-400 font-medium">
            <span suppressHydrationWarning>Report Generated Electronically on: {new Date(summary.generatedAt).toLocaleString()}</span>
