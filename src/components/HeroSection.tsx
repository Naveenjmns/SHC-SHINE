      ...
      <div className="container-shine relative z-10 w-full flex flex-col items-center justify-center text-center py-6 md:py-12">
        ...
        <div className="mb-6 md:mb-8 animate-stage-logo w-full flex justify-center">
          {logoUrl ? (
            ...
            <div className="relative inline-flex flex-col items-center justify-center p-8 md:p-12" suppressHydrationWarning>
              <div
                suppressHydrationWarning
                className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-gradient-to-br from-[var(--fest-ember)] to-[var(--fest-gold)] flex items-center justify-center text-white font-black text-4xl md:text-5xl shadow-2xl shadow-orange-500/40"
              >
                {eventName.charAt(0)}
              </div>
              <div
                suppressHydrationWarning
                className="flex items-center gap-2 text-xs md:text-sm font-extrabold uppercase tracking-widest text-[var(--fest-ember)] mt-4"
              >
